...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { first_name: @table.first_name, food: @table.food, last_name: @table.last_name, number: @table.number } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { first_name: @table.first_name, food: @table.food, last_name: @table.last_name, number: @table.number } }
